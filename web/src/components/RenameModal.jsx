...
export default function FileUpload({ callback }) {
  ...
  const handleUploadClick = async () => {
    ...
    try {
      ...
      if (response.data.uploadLimitReached) {
        setError("Se ha alcanzado el límite de carga de su plan de afiliación");
      } else {
      ...
      if (error.response && error.response.status === 403) {
        ...
        setError("Lo lamentamos, solo permitimos archivos tipo excel solamente");
      }
